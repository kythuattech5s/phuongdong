...
<div class="<?php echo $idfile; ?>">
	...
	<div class="btnadmin">
		<a href="javascript:void(0)" onclick="window['elementor_json_field_<?php echo $key; ?>'].changeDetailImage('<?php echo $idfile ?>')" class="btn btnchange-<?php echo $idfile ?>" type="button">Sửa thông tin cơ bản</a>
	</div>
	<div class="btnadmin">
		<a href="javascript:void(0)" onclick="window['elementor_json_field_<?php echo $key; ?>'].deleteImage('<?php echo $idfile ?>')" class="btn btndelete-<?php echo $idfile ?>" type="button">Xóa ảnh</a>
	</div>
</div>