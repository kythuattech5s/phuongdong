<picture>
	...
	<img loading="lazy" src="{%IMGV2.itemImage.img.500x0%}" data-src="{%IMGV2.itemImage.img.500x0%}" title="{%AIMGV2.itemImage.img.title%}" alt="{%AIMGV2.itemImage.img.alt%}" class="img-fluid">
</picture>