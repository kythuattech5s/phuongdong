<a href="tel:{[hotline]}" class="btn-call" title="Hotline">
	<span>
...
<div class="container">
	@include('banner_gdn.banner_gdn_footer')
</div>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<div class="list-social mb-3 mb-xxl-4">
					<a href="{[facebook]}" class="smooth" target="_blank" rel="noopener" title="Facebook">
						<i class="fa fa-facebook" aria-hidden="true"></i>
					</a>
					<a href="{[youtube]}" class="smooth" target="_blank" rel="noopener" title="Youtube">
						<i class="fa fa-youtube-play" aria-hidden="true"></i>
					</a>
					<a href="{[tiktok]}" class="smooth" target="_blank" rel="noopener" title="Tiktok">
