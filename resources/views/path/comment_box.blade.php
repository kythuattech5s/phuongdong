<div class="comment-box__content">
    <div class="comment-box__form">
        <form action="binh-luan/" method="POST" clear class="formValidation overflow-hidden" parent=".form-group"
            data-success="COMMENT.receivedComment" absolute>
            @csrf
            ...
            <div class="form-group">
                <textarea id="comment" class="form-control" name="content" rules="required"
                    ...
                    placeholder="Trở thành người đầu tiên bình luận cho bài viết này"></textarea>
            </div>
